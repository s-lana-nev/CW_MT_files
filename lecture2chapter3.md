...
ТУТ КАРТИНКА "Лекция2Часть3Рис7.png"
...
ТУТ КАРТИНКА "Лекция2Часть3Рис8.png"
![](//https://drive.google.com/file/d/1X4C82SPGnjgV2wDEHRu2GWntH33e03CO/view?usp=sharing)
...
ТУТ КАРТИНКА "Лекция2Часть3Рис9.png"
![](//https://drive.google.com/file/d/1eMqkANk6RaRBKxVrAsK2F-YOlDiTkGbk/view?usp=sharing)
...
6)	Процедура <арифметическое выражение> распознаёт лексему – ,  затем   вызывает процедуру <слагаемое>, которая вызывает процедуру <значение>, которая распознаёт лексему ид и передаёт управление в процедуру <слагаемое> (рис. 10б).
